...
| [`tide_slime_chain.js`](../pack/kubejs/server_scripts/tide_slime_chain.js)              | 4 Tide  | pink_slime (Bog bridge) -> prismarine -> prismarine_crystals -> sponge -> ink_sac -> sea_pickle -> nautilus_shell (filler: mycelium) |
