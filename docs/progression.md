...
- **Gate to Tier 5:** complete `drowned_riches` (capstone = nautilus_shell). Priming the Spawnery with nautilus_shell draws the Infernal Frogspawn (the `road_to_infernal` gateway).
