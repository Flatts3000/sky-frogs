...
| Tier 3: Bog | `powered_up.snbt`            | The **power-scaling arc** (#109): Powah from Furnator to Starter Reactor + the Flux Networks crossover, rooted at the Bog clay quest (dielectric paste is the gate). Froglight-check quests for all 8 modded variants; teaches the make-it-first chamber law and split-discovery. |
