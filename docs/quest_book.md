...
| Completionist | `sister_ponds.snbt`          | **Sister Ponds** (#121, same generator): the modded census - one column per loaded mod (ATO, Powah, RS, Mekanism, IF, Flux Networks; 26 quests today), same capstone pattern. Re-run the generator on every PF pin bump. |
