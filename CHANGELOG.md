...
- **Tier 1: Cave Frogs** chapter stubbed (`cave_frogs.snbt`, intro quest gated behind Scaling the Colony) - the per-resource seed-chain (copper -> gold -> ... via slime-in-a-bucket recipes) lands here next.
