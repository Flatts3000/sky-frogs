...
- Productive Frogs added from CurseForge (project-id 1552728), pinned at **v1.2.0** — the pack's load-bearing core mod, via packwiz (initially v1.0.1; updated to v1.2.0 once it cleared CF review, unlocking the 57-variant resource set, component-driven Slime Milk, and data-driven spawn eggs).
