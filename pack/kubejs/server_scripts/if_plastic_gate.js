...
// Removing it makes the Bog plastic Froglight (the configurable_froglight carrying
// slime_variant=plastic, whose smelt recipe stays) the ONLY source of plastic - so
// progressing Industrial Foregoing requires
