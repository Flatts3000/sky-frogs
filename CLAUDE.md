...
- Productive Frogs: **published on CurseForge** (slug `productive-frogs`, project-id `1552728`) as of 2026-05-25. Added to the pack via `packwiz cf add productive-frogs`; currently pinned at `productivefrogs-1.2.0.jar` (1.21.1 / NeoForge; updated from 1.0.1 on 2026-05-25 once 1.2.0 cleared CF review). Pull newer files with `packwiz update productive-frogs`.
