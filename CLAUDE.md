...
- Loader: **NeoForge 21.1.233** (bumped from 21.1.230 on 2026-06-10; 230 applied the `GuiGraphics` tooltip patch unreliably on some fresh installs, crashing Apotheosis's required accessor at load - keep the pin current and off known-bad builds)
- Java: **21**
...
`pack/` is initialized (packwiz, MC 1.21.1 / NeoForge 21.1.233). All packwiz commands run from inside `pack/`:
